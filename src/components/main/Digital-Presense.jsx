            ...
            <div className="dp-digital-visual">
              ...
              <div className="dp-social-icons-group">
                <div className="dp-social-icon facebook">
                  <a href="https://www.facebook.com/profile.php?id=61564970678171" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                ...
                <div className="dp-social-icon instagram">
                  <a href="https://www.instagram.com/workzenco/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="dp-social-icon twitter">
                  <a href="https://x.com/workzenco" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="dp-social-icon linkedin">
                  <a href="https://www.linkedin.com/company/workzen360/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="dp-device-frame">
                  <div className="dp-device-screen">
                    ...
                    <div className="dp-social-icons">
                      <div className="dp-social-icon facebook">
                        <a href="https://www.facebook.com/profile.php?id=61564970678171" target="_blank" rel="noopener noreferrer" aria-label="Facebook"></a>
                      </div>
                      <div className="dp-social-icon instagram">
                        <a href="https://www.instagram.com/workzenco/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"></a>
                      </div>
                      <div className="dp-social-icon twitter">
                        <a href="https://x.com/workzenco" target="_blank" rel="noopener noreferrer" aria-label="Twitter"></a>
                      </div>
                      <div className="dp-social-icon linkedin">
                        <a href="https://www.linkedin.com/company/workzen360/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn"></a>
                      </div>
                    </div>
                  </div>
                </div>
